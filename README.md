# CodeAlpha Data Analytics – EDA & Visualization
...
1. **Monthly Revenue Contribution by Product Category**  
   - Area chart showing seasonal demand patterns.  
   - Insight: Decor and Toys peak during holidays; Stationery remains steady.  

2. **Customer Segmentation by Revenue**  
   - Donut chart showing Low, Medium, High, and VIP spenders.  
   - Insight: Most customers are medium spenders, but VIPs drive significant value.  

3. **Customer Purchase Behavior**  
   - Pie chart of repeat vs one‑time customers.  
   - Insight: 65% are repeat buyers, showing strong loyalty.  

4. **Revenue by Weekday**  
   - Bar chart showing weekday vs weekend sales.  
   - Insight: Weekday sales dominate, suggesting business customers drive purchases.  
